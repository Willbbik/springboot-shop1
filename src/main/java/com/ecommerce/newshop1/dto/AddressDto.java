...
public class AddressDto {
    ...
    @Length(max = 100, message = "주문자 성함의 최대 길이는 100자 입니다.", groups = ValidationGroups.LengthGroup.class)
    ...
    @Length(max = 100, message = "수령인 성함의 최대 길이는 100자 입니다.", groups = ValidationGroups.LengthGroup.class)
